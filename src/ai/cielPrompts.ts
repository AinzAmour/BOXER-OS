// ─────────────────────────────────────────────────────────────
// CIEL — LIFE//OS AI System Prompts & Core Identity
// ─────────────────────────────────────────────────────────────
...
export const CIEL_MODES: Record<CielMode, string> = {
  onboarding: `
...
export function buildCielSystemPrompt(mode: CielMode, userContext: string): string {
  return [
    CIEL_CORE_IDENTITY,
    CIEL_MODES[mode] || CIEL_MODES.scheduling,
